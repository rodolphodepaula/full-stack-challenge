...
class TrackRequest  extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'artist_uuids.array' => 'O campo uuid do artista deve ser um array.',
            'artist_uuids.*.uuid' => 'O campo uuid do artista deve conter UUIDs válidos.',
            'artist_uuids.*.exists' => 'O artista selecionado não existe.',
